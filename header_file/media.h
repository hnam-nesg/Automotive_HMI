...
class Media:public QObject{
    ...
    Q_PROPERTY(bool state READ getState WRITE setState NOTIFY signal_state);
    Q_PROPERTY(QString play_pause READ getPlay_pause WRITE setPlay_pause NOTIFY signal_play_pause);
...
private:
    ...
    void setPlay_pause(QString play);
...
signals:
    ...
    void signal_state(bool mode);
    void signal_play_pause(QString play);
